...
class Data:
    ...
    forward_yerr           : Dict[str, np.ndarray] = field(default_factory=dict)
    ...
    poly_inputs            : Dict[str, np.ndarray] = field(default_factory=dict)
    # TODO: Add description of available keys to above
    ...
    # #: The concatenated array of initial profile and poly coefficients, has keys "initial" and "masked".
    # model_inputs           : Dict[str, np.ndarray] = field(default_factory=dict)
