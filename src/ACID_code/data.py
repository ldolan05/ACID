...
class Data:
    ...
    #: The alpha vector used for the fitting after residual masking, which is updated in the residual masking step
    alpha_fitting          : Optional[np.ndarray] = None 
    ...
    #: Boolean 1D mask on "combined" grid, used to mask out NaN/invalid values to go from initial to the combined spectra
    ...
    #: Boolean 1D mask on "combined" grid, that masks regions on residuals for the MCMC fitting
    fitting_mask         : Optional[np.ndarray] = None
